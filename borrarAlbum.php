...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($sql)) {
        $exito = "Álbum eliminado correctamente.";
    } else {
...
<body>
    ...
    <div class="contenido">
        <section class="form-registro">
            ...
            <?php
            $sql = "SELECT id, artista, nombre FROM albums";
            ...
            while ($fila = $resultado->fetch_assoc()) {
                ...
                <form action='borrarAlbum.php' method='POST'>
                    ...
                    <div class='album-item'>
                        <span>{$fila['artista']} — {$fila['nombre']}</span>
                        <button class='buttons' type='submit' onclick='return confirm(\"¿Seguro que deseas borrar este álbum?\")'>Borrar</button>
                    </div>
                </form>";
            }
            ?>
